...
//    {
////        $user = null;
//        $user = "null - checked worked and returned false";
//    }
//else {
//    $user = Auth::user();
//}
                    ...
                    @foreach($recipes as $r)
                        <div class="row featurette">
                            <div class="col-md-7 order-md-2">
                                <h2 class="featurette-heading text-warning"><a href="{{ url('recipes', $r->id) }}" class="link-info text-decoration-none text-warning">{{ $r->name }}</a></h2>
                                <p class="lead">
                                    {{ $r->description }}
                                </p>
                                <p><a href="{{ $r->website }}" class="link-info text-decoration-none text-highlighted lead">{{ $r->website }}</a></p>
...
{{--        <p>NO IF CATCHES IF ONLY THIS IS DISPLAYED {{var_dump($user)}}</p>--}}
